...
screen.innerHTML=`<div class="login-art"><div class="os-logo"><svg class="msme-mark" viewBox="0 0 96 64" role="img" aria-label="MSME M logo"><defs><linearGradient id="msme-left" x1="0" y1="0" x2="1" y2="1"><stop offset="0" stop-color="#ff7b9d"/><stop offset=".48" stop-color="#b24fff"/><stop offset="1" stop-color="#315dff"/></linearGradient><linearGradient id="msme-right" x1="0" y1="0" x2="1" y2="1"><stop offset="0" stop-color="#955cff"/><stop offset=".48" stop-color="#3974ff"/><stop offset="1" stop-color="#25c9ef"/></linearGradient></defs><path d="M11 51 28 17c3-7 10-8 14 0l10 21" fill="none" stroke="url(#msme-left)" stroke-width="15" stroke-linecap="round" stroke-linejoin="round"/><path d="M52 38 64 16c4-7 10-7 14 1l9 34" fill="none" stroke="url(#msme-right)" stroke-width="15" stroke-linecap="round" stroke-linejoin="round"/></svg><span class="msme-logo-copy"><b>MSME</b><small>Track • Manage • Grow</small></span></div><div class="art-copy"><h2>MSME<br><i>MULTI SKILL</i><br><i>PLANNER</i></h2><span></span><p>A smart workforce management system for Indian MSMEs to plan, manage and optimize employee skills, attendance and efficiency.</p></div><div class="login-benefits"><span><b>♙</b>Manage<br>Workforce</span><span><b>◷</b>Track<br>Attendance</span><span><b>✦</b>Grow<br>Together</span></div></div><div class="login-side"><div class="login-card"><p class="eyebrow">WELCOME BACK</p><h1>Welcome to your workspace</h1><p class="login-copy">Sign in or create a private MSME account.</p><div class="access-switch"><button data-access="workspace" class="active">Workspace - Admin</button><button data-access="worker">Workspace - E / S / W / TW</button></div><div class="auth-tabs"><button data-tab="signin" class="active">Sign in</button><button data-tab="signup">Create profile</button></div><div id="owned-auth-panel"></div></div></div>`;
